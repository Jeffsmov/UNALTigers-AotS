...
COLOR_MAPS = {
    ...
    "Infrastructure": "PuBuGn_09",
    "Child Vulnerability": "YlOrBr_09",
    "Weather Scenarios": "RdYlBu_11"
}
...
def main():
    st.title("🌪️ Risk and Climate Exposure Dashboard - Haiti")
